...
<div class="page-hero">
    ...
    <p class="ar">{{ $siteSettings['site_name_ar'] ?? 'SkyRoute' }} — منصتك الموثوقة لمقارنة أسعار الطيران</p>
    <p class="en">{{ $siteSettings['site_name_en'] ?? 'SkyRoute' }} — Your trusted platform for comparing flight prices</p>
</div>
...
<div class="page-content">
    ...
    <div class="about-grid">
        <div>
            ...
            <p style="color:var(--ink-3);line-height:1.8;margin-bottom:1rem" class="ar">
                {{ $siteSettings['site_name_ar'] ?? 'SkyRoute' }} هي منصة متخصصة في مقارنة أسعار تذاكر الطيران من مئات شركات الطيران ووكالات السفر العالمية.
                هدفنا أن نوفر لك أفضل سعر ممكن في أقل وقت.
            </p>
            <p style="color:var(--ink-3);line-height:1.8;margin-bottom:1rem" class="en">
                {{ $siteSettings['site_name_en'] ?? 'SkyRoute' }} is a specialized platform for comparing flight ticket prices from hundreds of airlines and global travel agencies.
        ...
        <div style="background:linear-gradient(135deg,var(--sky),#0f3fcf);border-radius:20px;padding:3rem;color:#fff;text-align:center">
            ...
            <div style="opacity:0.8;font-size:0.95rem" class="ar">{{ $siteSettings['site_tagline_ar'] ?? 'رحلاتك بين يديك' }}</div>
            <div style="opacity:0.8;font-size:0.95rem" class="en">{{ $siteSettings['site_tagline_en'] ?? 'Your flights at your fingertips' }}</div>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom:2rem">
        <h3 style="font-family:'DM Serif Display',serif;font-size:1.5rem;margin-bottom:1.5rem" class="ar">لماذا {{ $siteSettings['site_name_ar'] ?? 'SkyRoute' }}؟</h3>
        <h3 style="font-family:'DM Serif Display',serif;font-size:1.5rem;margin-bottom:1.5rem" class="en">Why {{ $siteSettings['site_name_en'] ?? 'SkyRoute' }}?</h3>
