...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'لوحة التحكم'); ?> — <?php echo e($siteSettings['site_name_ar'] ?? 'SkyRoute'); ?> Admin</title>
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('admin.searches.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.searches.*') ? 'active' : ''); ?>">
            <span class="nav-icon">🔍</span> البحثات
        </a>
        <a href="<?php echo e(route('admin.clicks.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.clicks.*') ? 'active' : ''); ?>">
            <span class="nav-icon">👆</span> النقرات
        </a>

        <div class="nav-section" style="margin-top:0.5rem">الإعدادات</div>
        <a href="<?php echo e(route('admin.routes.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.routes.*') ? 'active' : ''); ?>">
            <span class="nav-icon">✈️</span> الوجهات الشائعة
        </a>
        <a href="<?php echo e(route('admin.sources.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.sources.*') ? 'active' : ''); ?>">
            <span class="nav-icon">🔗</span> مصادر الأفلييت
        </a>
        <a href="<?php echo e(route('admin.announcements.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.announcements.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('admin.subscribers.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.subscribers.*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        <?php echo e(session('admin_name', 'المدير')); ?>

        &nbsp;·&nbsp;
        <a href="<?php echo e(route('admin.logout')); ?>">تسجيل خروج</a>
    </div>
</aside>

<div class="main">
    <div class="topbar">
        <div class="topbar-title"><?php echo $__env->yieldContent('title', 'لوحة التحكم'); ?></div>
        <div class="topbar-admin">👤 <?php echo e(session('admin_name', 'المدير')); ?></div>
    </div>
    <div class="content">
...
<?php /**PATH C:\Users\kozer\Desktop\KozerTravel\resources\views/admin/layout.blade.php ENDPATH**/ ?>