...
<head>
    ...
    <title><?php echo e($siteSettings['site_name_ar'] ?? 'SkyRoute'); ?> — نتائج البحث</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
            ...
            --sky: <?php echo e($siteSettings['primary_color'] ?? '#2563eb'); ?>;
            --sky-lt: color-mix(in srgb, <?php echo e($siteSettings['primary_color'] ?? '#2563eb'); ?> 10%, white);
...
<div class="search-bar">
    <div class="route-pill"><?php echo e($origin); ?> <?php echo e($tripType === 'roundtrip' ? '⇄' : '✈'); ?> <?php echo e($destination); ?></div>
    ...
    <div class="search-meta">
        ...
        → <?php echo e(\Carbon\Carbon::parse($returnDate)->format('d M Y')); ?>

        <?php endif; ?>
        · <?php echo e($adults); ?> <span class="ar">بالغ</span><span class="en">adult(s)</span>
    </div>
    <a href="/search?origin=<?php echo e($origin); ?>&destination=<?php echo e($destination); ?>&date=<?php echo e($date); ?>&adults=<?php echo e($adults); ?>&trip_type=<?php echo e($tripType); ?><?php echo e($returnDate ? '&return_date='.$returnDate : ''); ?>"
       class="edit-search">
...
<div class="container">
    ...
    <div class="results-header">
        <div>
            <div class="results-title ar">
                وجدنا <strong><?php echo e(count($sources)); ?></strong> مصادر لرحلة <?php echo e($origin); ?> <?php echo e($tripType === 'roundtrip' ? '⇄' : '←'); ?> <?php echo e($destination); ?>

                <?php if($tripType === 'roundtrip'): ?><span style="font-size:0.82rem;color:var(--ink-3)"> · ذهاب وإياب</span><?php endif; ?>
            </div>
            <div class="results-title en">
                Found <strong><?php echo e(count($sources)); ?></strong> sources for <?php echo e($origin); ?> <?php echo e($tripType === 'roundtrip' ? '⇄' : '→'); ?> <?php echo e($destination); ?>
    ...
    <?php $__currentLoopData = $sources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php $isFirst = $i === 0; ?>
    <a href="<?php echo e($source['url']); ?>" target="_blank" rel="noopener"
       class="source-card <?php echo e($isFirst ? 'best-value' : ''); ?>"
       style="--card-color: <?php echo e($source['color']); ?>"
       data-source="<?php echo e($source['name']); ?>"
       data-origin="<?php echo e($origin); ?>"
       data-destination="<?php echo e($destination); ?>"
       onclick="trackClick(this)">
        ...
        <div class="source-left">
            <div class="source-icon" style="background: <?php echo e($source['color']); ?>">
                <?php echo e(strtoupper(substr($source['name'], 0, 2))); ?>

            </div>
            <div class="source-info">
                <div class="source-name"><?php echo e($source['name']); ?></div>
                <div class="source-label ar"><?php echo e($source['label_ar']); ?></div>
                <div class="source-label en"><?php echo e($source['label_en']); ?></div>
                <div class="source-desc">
                    <span class="ar"><?php echo e($sourceDescriptions[$source['name']]['ar'] ?? ''); ?></span>
                    <span class="en"><?php echo e($sourceDescriptions[$source['name']]['en'] ?? ''); ?></span>
                    <?php if(isset($sourceTags[$source['name']])): ?>
                        <?php $__currentLoopData = $sourceTags[$source['name']]['ar'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="source-tag ar"><?php echo e($tag); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $sourceTags[$source['name']]['en'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="source-tag en"><?php echo e($tag); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="source-right">
            ...
            <button class="book-btn" style="background: linear-gradient(135deg, <?php echo e($source['color']); ?>, <?php echo e($source['color']); ?>cc)">
...
</html><?php /**PATH C:\Users\kozer\Desktop\KozerTravel\resources\views/results.blade.php ENDPATH**/ ?>