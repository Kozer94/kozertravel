...
<head>
    ...
    <title>@yield('title', $siteSettings['site_name_ar'] ?? 'SkyRoute') — {{ $siteSettings['site_name_ar'] ?? 'SkyRoute' }}</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
            ...
            --sky: {{ $siteSettings['primary_color'] ?? '#1a5fff' }};
            --sky-lt: {{ $siteSettings['primary_color'] ?? '#1a5fff' }}22;
        ...
        input:focus, textarea:focus, select:focus { border-color: var(--sky); box-shadow: 0 0 0 3px {{ $siteSettings['primary_color'] ?? '#1a5fff' }}18; }
...
<nav>
    ...
    <ul>
        <li><a href="/" class="ar {{ request()->is('/') ? 'active' : '' }}">الرئيسية</a><a href="/" class="en {{ request()->is('/') ? 'active' : '' }}">Home</a></li>
        <li><a href="/search" class="ar {{ request()->is('search') ? 'active' : '' }}">الرحلات</a><a href="/search" class="en {{ request()->is('search') ? 'active' : '' }}">Flights</a></li>
        <li><a href="/deals" class="ar {{ request()->is('deals') ? 'active' : '' }}">العروض</a><a href="/deals" class="en {{ request()->is('deals') ? 'active' : '' }}">Deals</a></li>
        <li><a href="/blog" class="ar {{ request()->is('blog*') ? 'active' : '' }}">المدونة</a><a href="/blog" class="en {{ request()->is('blog*') ? 'active' : '' }}">Blog</a></li>
        <li><a href="/contact" class="ar {{ request()->is('contact') ? 'active' : '' }}">تواصل معنا</a><a href="/contact" class="en {{ request()->is('contact') ? 'active' : '' }}">Contact</a></li>
    </ul>
...
<footer>
    <div class="footer-main">
        <div class="footer-brand">
            <span class="f-logo">{{ $siteSettings['site_name_ar'] ?? 'SkyRoute' }}</span>
    ...
    <div class="footer-bottom">
        <span>© {{ date('Y') }} {{ $siteSettings['site_name_ar'] ?? 'SkyRoute' }} ·
